...
<head>
    ...
    <title>Print Jurnal Penyesuaian</title>
</head>
<body class="px-5" style="font-size: 12pt">
    @include('layouts.header-print')
    <div class="row mb-2">
        <div class="col-md-12 text-center">
            <h2 class="mb-1">Jurnal Penyesuaian</h2>
            ...
            <table border="1" width="100%">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th class="text-right px-1">Rp{{number_format($debit, 2, ',','.')}}</th>
                        <th class="text-right px-1">Rp{{number_format($kredit, 2, ',','.')}}</th>
                    </tr>
                </tfoot>
            </table>
        </div>
