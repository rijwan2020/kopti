...
<div class="row">
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('journalList', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
    ...
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('adjustingJournalList', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
    ...
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('ledger', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
    ...
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('trialBalance', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
...
<div class="row">
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('balance', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
    ...
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('balanceDescription', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
    ...
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('phu', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
    ...
    <div class="col-sm-6 col-md-4 col-xl-3">
        <a href="{{ route('shu', ['tbb_id' => $data['data']->id]) }}" class="text-dark">
            <div class="card mb-3" id="shortcut">
                <div class="card-body">
                    <div class="d-flex align-items-center">
