    ...
    <div class="col-md-12">
        <div class="card">
                ...
                <table class="table card-table table-bordered">
                    <thead class="thead-light">
                        <tr class="text-center">
                            ...
                            <th class="align-middle">Saldo Tanggal {{ date('d-m-Y', strtotime('-1 day', strtotime($data['start_periode']))) }} (Rp)</th>
                            <th class="align-middle">Debit (Rp)</th>
                            <th class="align-middle">Kredit (Rp)</th>
                            <th class="align-middle">Saldo Tanggal {{ date('d-m-Y', strtotime($data['end_periode'])) }} (Rp)</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
            ...
            <div class="card-footer">
                ...
                <form action="{{ route('closeMonthlyBookConfirm') }}" class="text-center" method="POST">
                    @csrf
