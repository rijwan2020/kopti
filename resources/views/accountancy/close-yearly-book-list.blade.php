...
<div class="ui-bordered px-3 pt-3 mb-3">
    <form class="form-row align-items-center" method="get" action="{{ url()->current() }}">
        ...
        <div class="col-md text-right">
            @if (Auth::user()->hasRule('closeYearlyBookAdd'))
                <a href="{{ route('closeYearlyBookAdd') }}" class="btn btn-info mb-3" data-toggle="tooltip" data-state="dark" data-placement="bottom" data-original-title="Tambah Data Tutup Buku tahunan">
                        ...
                        @foreach ($data['data'] as $value)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if (Auth::user()->hasRule('closeYearlyBookDetail'))
                                        <a href="{{ route('closeYearlyBookDetail', ['id' => $value->id]) }}" class="btn icon-btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" data-state="dark" title="Detail Tutup Buku">
