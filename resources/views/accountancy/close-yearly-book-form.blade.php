...
<div class="card">
    <div class="card-header h4 text-center">Form Tutup Buku Tahunan</div>
    <form action="{{ route('closeYearlyBookPreview') }}" class="form-input" method="post" autocomplete="false">
        <div class="card-body">
            @csrf
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Masukan tanggal tutup buku Tahunan koperasi.</small>
                    </div>
