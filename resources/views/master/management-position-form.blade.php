...
<div class="card">
    <div class="card-header h4 text-center">Form Jabatan Pengurus</div>
    <form action="{{ route('managementPositionSave') }}" enctype="multipart/form-data" class="form-input" method="post" autocomplete="false">
        <div class="card-body">
            @csrf
            ...
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Masukan nama jabatan.</small>
                    </div>
                    ...
                    @if ($data['mode']=='add')
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Pilih level user untuk jabatan.</small>
                        </div>
                    @else
                        <div class="form-group">
                            <label class="form-label">Level User*</label>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Masukan deskripsi jabatan.</small>
                    </div>
