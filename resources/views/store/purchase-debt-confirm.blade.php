...
<div class="card">
    ...
    <form action="{{ route('purchaseDebtSave') }}" enctype="multipart/form-data" class="form-input" method="post" autocomplete="false" id="form-bayar-utang">
        <div class="card-body">
            @csrf
            ...
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $data['debt']->purchase->no_faktur }}" disabled>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Suplier</label>
                        <input type="text" class="form-control" value="{{ $data['debt']->suplier->name }}" disabled>
                    </div>
        ...
        <div class="card-footer text-center">
            ...
            <a href="{{ route('purchaseDebtPay', ['id'=>$data['id']]) }}" class="btn btn-danger" title="Batalkan transaksi">Batal</a>
        </div>
    </form>
</div>
@endsection