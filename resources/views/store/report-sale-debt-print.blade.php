    ...
    <div class="row">
        <div class="col-md-12">
            <table border="1" width="100%">
                ...
                <tbody>
                    <tr class="text-right">
                        <th colspan="6" class="px-1">Saldo {{ date('d-m-Y', strtotime('-1 day', strtotime($data['start_date']))) }}</th>
                    ...
                    @foreach ($data['data'] as $value)
                        ...
                        <tr>
                            ...
                            <td class="px-1">{{ $value->sale->status_pembayaran == 1 ? 'Lunas' : 'Belum Lunas' }}</td>
