...
<div class="ui-bordered px-3 pt-3 mb-3">
    <form class="form-row align-items-center" method="get" action="{{ url()->current() }}">
        ...
        <div class="col-md-6 text-right">
            @if (Auth::user()->hasRule('storeReportUtangDetailPrint'))
            <a href="{{ route('storeReportUtangDetailPrint', ['id' => $data['data']->id,'start_date' => $data['start_date'], 'end_date' => $data['end_date']]) }}" class="btn my-1 btn-dark" data-toggle="tooltip" data-state="dark" title="Print" target="_blank">
                <i class="fa fa-print"></i>
                Print
            </a>
            @endif
            @if (Auth::user()->hasRule('storeReportUtangDetailDownload'))
                <a href="{{ route('storeReportUtangDetailDownload', ['id' => $data['data']->id,'start_date' => $data['start_date'], 'end_date' => $data['end_date']]) }}" class="btn my-1 btn-success" data-toggle="tooltip" data-state="dark" title="Download">
