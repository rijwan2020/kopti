...
<div class="card">
    ...
    <form action="{{ route('saleDebtConfirm') }}" enctype="multipart/form-data" class="form-input" method="post" autocomplete="false" id="form-bayar-utang">
        <div class="card-body">
            @csrf
            ...
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $data['data']->warehouse->name ?? 'Pusat' }}" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="account" id="account" class="form-control select2 {{ $errors->has('account')?' is-invalid':'' }}" required>
