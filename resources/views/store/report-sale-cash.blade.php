...
<div class="ui-bordered px-3 pt-3 mb-3">
    <form class="form-row align-items-center" method="get" action="{{ url()->current() }}">
        ...
        <div class="col-md-3 text-right">
            <a href="{{ route('storeReportSaleCashPrint', [$data['param']]) }}" class="btn my-1 btn-dark" data-toggle="tooltip" data-state="dark" title="Print" target="_blank">
                <i class="fa fa-print"></i>
                Print
            </a>
            <a href="{{ route('storeReportSaleCashDownload', [$data['param']]) }}" class="btn my-1 btn-success" data-toggle="tooltip" data-state="dark" title="Download">
        ...
        <div class="card">
            ...
            <div class="table-responsive">
                <table class="table card-table table-bordered">
                    ...
                    <tbody>
                        <tr class="text-right">
                            <th colspan="5">Saldo {{ date('d-m-Y', strtotime('-1 day', strtotime($data['start_date']))) }} :</th>
...
@else
    <div class="card">
        <div class="card-header h4 text-center">Filter Laporan Penjualan Tunai</div>
