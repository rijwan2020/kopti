...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header h4 text-center">Data Utang Barang</div>
                ...
                <table class="table card-table">
                    ...
                    <tbody>
                        ...
                        @foreach ($data['data'] as $value)
                            ...
                            <tr>
                                <td>{{ $i }}</td>
                                <td>{{ $value->purchase->no_faktur }}</td>
                                ...
                                <td class="text-center">
                                    @if ($value->status == 0 && Auth::user()->hasRule('purchaseDebtPay'))
                                        <a href="{{ route('purchaseDebtPay', ['id' => $value->id]) }}" class="btn icon-btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" data-state="dark" title="Bayar Utang">
