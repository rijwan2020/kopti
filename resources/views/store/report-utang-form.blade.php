...
@section('module', 'Rekapitulasi Utang')

@section('content')
<div class="card">
    <div class="card-header h4 text-center">Form Rekapitulasi Utang</div>
    <form action="{{ route('storeReportUtangSave') }}" enctype="multipart/form-data" class="form-input" method="post" autocomplete="false">
        <div class="card-body">
            @csrf
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <label class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tipe" value="1" {{ old('tipe')==1 ? 'checked' : ''}}>
